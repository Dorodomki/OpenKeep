...
/datum/outfit/job/roguetown/mercenary/valoria/pre_equip(mob/living/carbon/human/H)//average infantrymen merc class, 4 weapon skills like other merc classes and medium armor training
	..()
	if(H.mind)
