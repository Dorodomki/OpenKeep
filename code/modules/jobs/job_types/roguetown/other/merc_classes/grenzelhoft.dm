...
/datum/outfit/job/roguetown/mercenary/grenzelhoft/pre_equip(mob/living/carbon/human/H)//big weapon user that can interchange for a mace/shield, 4 weapon skills
	..()
	if(H.mind)
